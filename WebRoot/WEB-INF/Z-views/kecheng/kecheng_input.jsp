...
<body>
	<s:debug />
	<s:form action="kecheng_save" id="kecheng_inputForm" theme="simple">
		<table align="center">
			<tr>
		...
		<table align="center" border="1">
			...
			<tr>
				...
				<td>
					<%-- <s:textfield id="ktable.knature" name="ktable.knature"
						placeholder="课程性质" /> --%> <s:select cssStyle="width:100%"
						id="ktable.knature" name="ktable.knature" headerKey="-1"
						list="#{'':'---------请选择---------','学位':'学位','选修':'选修','必修':'必修','限选':'限选'}"
						required="true" /></td>
			</tr>
			<tr>
